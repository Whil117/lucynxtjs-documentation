...
Lucy means in spanish "Lucientemente" or "Reluciente", But why only Lucy? Well if called the library LUCE or LUCI is english means a fish pike and "luci" means lights u other mean. for that reason I called lucy with the complement Nxtjs that means Next.js
